...
- Папка `Radar Mokups/` (Figma-экспорты и референсные скриншоты) намеренно **исключена из репозитория** через `.gitignore`.
- Production-сборка полностью статическая (страницы пререндерятся) — деплоится на любой статический хостинг, Vercel или Cloudflare Pages.
